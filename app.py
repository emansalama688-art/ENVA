...
# ==========================================================
    ...
    st.subheader("التشجير الذكي المدعوم بالذكاء الاصطناعي")

    st.markdown("""
يقوم ENVA بتحليل نتائج الغطاء الأرضي
واقتراح أفضل المناطق المناسبة للتشجير
باستخدام الذكاء الاصطناعي وصور الأقمار الصناعية.

ENVA analyzes land cover and recommends
the most suitable afforestation locations
